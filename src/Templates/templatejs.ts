...
import { pastasUniversal } from './templatepastareact'
...
// REACT JS
// ==============================
export function frontendJS(projectPath: string) {
    pastasUniversal(projectPath, 'js')
...
// REACT TS
// ==============================
export function frontendTS(projectPath: string) {
    pastasUniversal(projectPath, 'ts')
...
// ANGULAR
// ==============================
export function angular(projectPath: string) {
    pastasUniversal(projectPath, 'ts')
